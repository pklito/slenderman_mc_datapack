...
execute if score #F5Prevention dev.config matches 1 run tellraw @s ["",{"text":"[ ✔ ]","color":"green","clickEvent":{"action":"run_command","value":"/function lito:config/f5_prevention_disable"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to disable ","color":"red"},"F5 prevention (shader)",{"text":".","color":"red"},{"text":"\nWhen enabled, players in F5 mode will have things covering their screen.","color":"gray"},{"text":"\nDefault: Enabled","color":"dark_gray"}]}}," F5 prevention"]
execute unless score #F5Prevention dev.config matches 1 run tellraw @s ["",{"text":"[ ❌ ]","color":"red","clickEvent":{"action":"run_command","value":"/function lito:config/f5_prevention_enable"},"hoverEvent":{"action":"show_text","contents":["",{"text":"Click to enable ","color":"green"},"F5 prevention (shader)",{"text":".","color":"green"},{"text":"\nWhen enabled, players in F5 mode will have things covering their screen.","color":"gray"},{"text":"\nDefault: Enabled","color":"dark_gray"}]}}," F5 prevention"]
