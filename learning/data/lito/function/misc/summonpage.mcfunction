...
$summon item_frame $(X) $(Y) $(Z) {Item:{id:"minecraft:map", components:{item_model:"slender:$(page_type)page",custom_model_data:{"floats":[1f]}}}, Invincible:1b, Facing:$(Facing), Tags:["page"], Invisible:1b}