...
execute if score @s player.flashing_light matches 0 run scoreboard players operation REMOVE temp -= FOURTH temp
execute if score @s player.flashing_light matches 0 run scoreboard players set FOURTH temp 0
# don't apply twice
