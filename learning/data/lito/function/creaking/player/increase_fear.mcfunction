...
execute if score @s item.flashlight_state matches 0..1 run scoreboard players operation REMOVE temp -= FOURTH temp
execute if score @s item.flashlight_state matches 0..1 run scoreboard players set FOURTH temp 0
# don't apply twice
