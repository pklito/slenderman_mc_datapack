...
execute if score @s core.sees_slender matches 1 if score @n[tag=slenderman_entity] ai.just_teleported matches 1 run function lito:creaking/player/start_flash
...
execute if entity @s[scores={core.fear=2300..,core.sees_slender=1},gamemode=adventure] unless entity @n[tag=slenderman_entity,scores={ai.busy=1}] run function lito:creaking/death/kill
