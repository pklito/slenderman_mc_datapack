...
execute if entity @s[scores={core.fear=2300..,core.sees_slender=1}] unless entity @n[tag=slenderman_entity,scores={ai.busy=1}] run function lito:creaking/death/kill
