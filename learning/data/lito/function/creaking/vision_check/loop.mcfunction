...
execute unless block ~ ~ ~ #lito:passable store success score RET temp run function lito:creaking/vision_check/block_check
execute unless score RET temp matches 0 positioned ^ ^ ^-0.05 unless block ~ ~ ~ #lito:passable store success score RET temp run function lito:creaking/vision_check/block_check
#If in a block
...
execute if score RET temp matches 0 positioned ^ ^ ^-0.1 positioned ~ ~-1 ~ facing entity @s eyes run return run function lito:creaking/vision_check/loop
