...
execute unless score @s sprinting matches 1 run effect give @s slowness 1 2 true
execute if score @s sprinting matches 1 run effect give @s slowness 1 1 true
