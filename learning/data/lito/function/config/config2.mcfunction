...
tellraw @s [{"text": "misc: "},{"text":"[randomize page]","color": "gold","clickEvent": {"action":"suggest_command","value": "/execute as @n[tag=page] store result entity @s Item.components.\"minecraft:custom_model_data\".floats[0] float 1 run random value 1..8"}}]
